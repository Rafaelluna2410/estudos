...
checkErr(err)
    ...
    result, err := insert.Exec(6, "Maps in Golang", "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium")
	checkErr(err)
...
func sqlUpdate(){
	...
	result, err := update.Exec("But I must explain to you how all this mistaken idea", 6)
	checkErr(err)
